const filterUpDownStocks = require('./filterUpDownStocks')
const technicalIndicators = require("../technical-Indicators/technicalIndicatorsMain")

async function compileStocks(arr1, arr2, arr3, arr4, callback, dateObj) {

  console.log('COMPLILE STOCKS')
    ...
    // MAKES STOCKS WITH ONLY 4 SYMBOLS
    ...
    const returnedData = await technicalIndicators.technicalIndicators(finalChart, filterUpDownStocks.filterUpDownStocks, dateObj); // TECHNICALINDICATORS.JS
    return returnedData;
}

module.exports = {compileStocks}